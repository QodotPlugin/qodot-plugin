...
static func spawn_face_mesh(brush: QuakeBrush, face: QuakeFace, texture_mapper: QodotTextureMapper, base_texture_path, material_extension, texture_extension, default_material, inverse_scale_factor):
